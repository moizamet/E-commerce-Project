...
<div class="mainwrap">
	...
	<div class="col-lg-9 ">
		...
		$query="SELECT * FROM project_product WHERE category='Clothes'";
		...
		if ($response)
		{
			while($product=mysqli_fetch_array($response))
			{
					...
					echo '	<div class="col-lg-5 jumbotron" style="margin:10px;margin-left:20px;background-color:#ccc;padding:10px; font-size:22px;font: italic 20px/30px Georgia, serif;">
